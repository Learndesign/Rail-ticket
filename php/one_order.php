...
<body>
    ...
    //$OR_SeatType=$_POST['SeatType'];
     ...
     $OR_StartStation  = $_SESSION['startStation'];
     ...
     if($OR_Price == 0)
       ...
       echo "<script>alert('已无余票!'); window.location.href='r4_find_train.php';</script>";
    else
     {
     $col = connect_db();
    ...
    //处理订单删除
     ...
     ."<input type='hidden' value='{$OR_SeatType}'  name='SeatType' readonly='readonly'/></td> "
    ...
    <p><a href="r4_find_train.php">返回车次查询</a></p>
</body>
